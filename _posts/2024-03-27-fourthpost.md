...
Finally, we clip the reconstructed image to the location shapefile. This is done to ensure that  neighbouring pixels are not included in the final image for further predictions and(or) calculations. 
